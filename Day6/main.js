...
//hide all the gif surprises
var image = document.getElementById('nod1');
image.style.visibility = 'hidden';

var image2 = document.getElementById('elf2');
image2.style.visibility = 'hidden';
var image3 = document.getElementById('oceans3');
image3.style.visibility = 'hidden';
var image4 = document.getElementById('jane4');
image4.style.visibility = 'hidden';

const button = document.getElementsByClassName("elevator-button")[0];
...
function welcomeBack(){
    ...
    welcomeBack.innerHTML= "Welcome back Traveler...";
}
